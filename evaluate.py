...
#         s = strategies[i]
model_path = "./checkpoint/20mins/best_lenet_MIX_20mins_fol_079.h5" 
best_model = keras.models.load_model(model_path)
lfp, afp = best_model.evaluate(fp_test, fp_test_labels, verbose=1)
# acc_fp[i].append(afp)

print("accuracy for 20 mins is: ", afp)
